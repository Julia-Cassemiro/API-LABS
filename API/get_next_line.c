...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/27 16:03:08 by jgomes-c          #+#    #+#             */
/*   Updated: 2022/02/27 16:03:08 by jgomes-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/include.h"

static char	*ft_strchar(const char *s, int c)
{
	int		i;
	char	found;
...
static char	*join_cct(char const *s1, char const *s2)
{
	int		i1;
	int		i2;
	char	*cc;
